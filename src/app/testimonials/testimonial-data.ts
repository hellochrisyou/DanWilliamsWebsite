...
export const TESTIMONIALCARD2: TestimonialCard = {
  cardTitle: 'Ramón Wodkowski',
  cardSubTitle: 'Professional Mouthpiece Craftsman',
  cardContent: 'Lorem ipsum dolor sit amet, iudico commune pri at, vel ei case phaedrum voluptatum. Est nostro oblique epicurei et. Vis quas posse et, in sea causae mollis. Soluta facilis phaedrum te sit, et errem quaestio est, doctus voluptatibus no ius. Ea his placerat deserunt salutatus.'
};

export const TESTIMONIALCARD3: TestimonialCard = {
  cardTitle: 'Sotos G. Djiovanis',
  cardSubTitle: 'Professional Oboist',
  cardContent: 'Lorem ipsum dolor sit amet, iudico commune pri at, vel ei case phaedrum voluptatum. Est nostro oblique epicurei et. Vis quas posse et, in sea causae mollis. Soluta facilis phaedrum te sit, et errem quaestio est, doctus voluptatibus no ius. Ea his placerat deserunt salutatus.'
};

export const TESTIMONIALIMAGES: string[] = [
  '../../assets/images/testimonial-main-1.jpg', '../../assets/images/testimonial-main-2.jpg', '../../assets/images/testimonial-main-3.jpg'
];

export const TESTIMONIALTABS: string[] = [
  '1', '2', '3'
];
